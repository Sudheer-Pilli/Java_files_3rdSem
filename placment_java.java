...
public class placment_java {
    public static void main(String[] args) throws ParseException, InterruptedException 
    {
        ...
        placement_thread place_thread = new placement_thread();
        ...
        } finally
        {
            ...
            System.out.println("Check if your details are correct while thread is waiting before proceding ");
            placement_thread.sleep(5000);
        }
